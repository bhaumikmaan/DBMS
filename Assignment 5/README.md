...
Query OK, 1 row affected (0.01 sec)
mysql> insert into Department values(2, 'Admin');
Query OK, 1 row affected (0.01 sec)
...
+------+-----------+
3 rows in set (0.00 sec)
mysql> insert into Project values (1,'Product Analysis','Noida');
Query OK, 1 row affected (0.01 sec)
mysql> insert into Project values (2,'Cloud marketing','Hyderabad');
Query OK, 1 row affected (0.01 sec)
mysql> insert into Project values (3,'AI chatbot','Jaipur');
Query OK, 1 row affected (0.02 sec)
